  ...
  return (
    <div className={styles.MyBookingScreen}>
      <div style={{ width: "100%", backgroundColor: "#c6c6c6" }}>
        ...
        <div className={styles.bookingReturn}>
          <p>หมายเลขการจอง : {rentalData[0].rentNumber}</p>
          <p>คืนรถแล้ว</p>
        </div>

        <div className={styles.car}>
          <img src={rentalData[0].imageUrl} className={styles.img} />
          <div
            style={{
              marginLeft: 10,
          ...
          >
            <p className={styles.titleCar}>{rentalData[0].title}</p>
            <div className={styles.desscription}>
              <TimeToLeaveIcon className={styles.icon} />
              <p className={styles.desText}>{rentalData[0].type}</p>

              <SettingsSuggestIcon className={styles.icon} />
              <p className={styles.desText}>{rentalData[0].transmission}</p>

              <PersonIcon className={styles.icon} />
              <p className={styles.desText}>{rentalData[0].seat}</p>

              <WorkIcon className={styles.icon} />
              <p className={styles.desText}>{rentalData[0].bag}</p>
            </div>
            <p className={styles.rental}>{rentalData[0].rental}</p>
          </div>
        </div>
          ...
          {expand && (
            <div style={{ margin: "10px 10px" }}>
              <div className={styles.rowData}>
                ...
                <p className={styles.detail}>{rentalData[0].day} วัน</p>
              </div>
              <div className={styles.rowData}>
                <p className={styles.title}>สถานที่รับ-ส่งรถ</p>
                <p className={styles.detail}>{rentalData[0].PickUp}{">"}{rentalData[0].DropOff}</p>
              </div>
              <div className={styles.rowData}>
        ...
        <div className={styles.status}>
          ...
          {status && (
            <div>
              ...
              <div className={styles.statusRow}>
                <div className={styles.confirmStatus} />
                <p className={styles.textConfirm}>รอการติดต่อจากบริษัทรถเช่า</p>
              </div>
              <div className={styles.statusRow}>
                <div className={styles.confirmStatus} />
                <p className={styles.textConfirm}>ได้รับอนุมัติการจองแล้ว</p>
              </div>
              <div className={styles.statusRow}>
                <div className={styles.confirmStatus} />
                <p className={styles.textConfirm}>รอชำระเงิน</p>
              </div>
              <div className={styles.statusRow}>
                <div className={styles.confirmStatus} />
                <p className={styles.textConfirm}>รอรับรถ</p>
              </div>
              <div className={styles.statusRow}>
                <div className={styles.confirmStatus} />
                <p className={styles.textConfirm}>คืนรถ การเช่าเสร็จสิ้น</p>
              </div>
            </div>
          )}
        </div>
